...
import { getTaskDetails, getProgress, getDayDetails, getConceptDetails, getRoadmap, type TaskDetails, type DayDetails, type ConceptDetails } from '../lib/api-roadmap'
    ...
    async function fetchTaskDetails() {
      ...
      try {
        ...
        if (data.project.project_id && data.day.day_id && data.concept.concept_id) {
          ...
          const nextDay = sortedDays.find(d => d.day_number === currentDayNumber + 1 && d.generated_status === 'generated')
